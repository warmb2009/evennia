    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_obj', models.ForeignKey(blank=True, to='objects.ObjectDB', help_text=b'the object to store this script on, if not a global script.', null=True, verbose_name=b'scripted object', on_delete=models.CASCADE)),
                ('db_account', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, help_text=b'the account to store this script on (should not be set if obj is set)', null=True, verbose_name=b'scripted account', on_delete=models.CASCADE)),
